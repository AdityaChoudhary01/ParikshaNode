...
const ProfilePage = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      // Normalize avatar in case backend sends string or object
      const newAvatar = typeof response.data.avatar === 'string'
        ? { url: response.data.avatar }
        : { url: response.data?.avatar?.url || response.data.avatar };

      const updatedUser = { ...response.data, avatar: newAvatar };
  ...
  const handleAvatarUpload = async () => {
    ...
    try {
      ...
      // Normalize avatar to { url: string }
      const newAvatar = typeof response.data === 'string'
        ? { url: response.data }
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Manage your ParikshaNode profile. Update your username, change your avatar, and view your quiz history."
        />
      </Helmet>
